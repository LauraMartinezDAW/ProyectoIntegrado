...
<head>
    ...
    <title>Introducir dirección | Soñando con suculentas</title>
</head>
<body>
<?php
    ...
    if (isset($_SESSION["usuario"])) {
        ...
        if (!empty($cesta)) {
            ...
            <main class="container pb-2 my-5">      
                <h2 class="mb-5 letraCursiva colorVerde display-4 text-center">Introduce tu primer apellido</h2>

                <form id="introducirApellido1" class="col-md-8 col-xl-4 mx-auto p-3 col-12" action="../controlador/ctrDireccionYapellido.php" method="post">   
                ...
                <div class="input-group mb-3">
                    ...
                    <div class="mt-4 d-flex justify-content-around">
                        <input class="btn boton2" type="submit" value="Confirmar apellido">
