...
<html lang="es">
    <head>
        ...
        <title>Cesta | Soñando con Suculentas</title>
    </head>
                ...
                if (!empty($cesta)) {
                        ...
                        <nav aria-label="breadcrumb" class="ps-4 col">
                            ...
                            <li class="breadcrumb-item ps-2"><a href="ctrTienda.php" class="migasPan">Tienda</a></li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <span class="migasPanActivo">Cesta</span>
                                </li>
                            </ol>
                        </nav>
                    ...
                    <main>           
                        <div class="container mb-4">
                            <h2 class="letraCursiva colorVerde text-center mt-3 mb-5 display-4">Tu cesta de la compra</h2>
                            <article>
                                <div class="row">
                                    <!-- Productos -->
                                        ...
                                        for ($i = 0; $i < count($cesta); $i++) {
                                            echo '<div class="card mb-3 col-md-6">
                                                <div class="row g-0">
                                                    ...
                                                    <div id="tarjetaProducto" class="col-md-8 d-flex align-items-center tarjetaCesta">
                                                        <div class="card-body text-center px-5 py-0 ">
                                                            <h3 class="card-title text-center colorVerde letraCursiva">' . $cesta[$i][1] . ' ' . $cesta[$i][4] .'</h3>
                                                            <p class="card-text text-center m-0">' . $cesta[$i][2] . '€ &nbsp;&nbsp;&nbsp;IVA incluído</p>
                                                            <p class="card-text text-center">Cantidad: ' . $cesta[$i][3] . '</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>';
                                    ...
                                    <section class="d-flex justify-content-center flex-column align-items-center my-5">
                                            <div class="col-11 col-md-7 mb-4 d-flex flex-column">
                                                <div class="col-12 d-flex justify-content-between border-bottom ">
                                                    <p class="col-11 mb-0">Subtotal</p><p class="text-end mb-0">' . $totalPedido .'€</p>
                                                </div>
                                                <div class="col-12 d-flex justify-content-between border-bottom ">
                                                    <p class="col-11 mb-0">Envío</p><p class="text-end mb-0">5€</p>
                                                </div>
                                                <div class="col-12 d-flex justify-content-between border-bottom ">
                                                    <p class="col-11 mb-0">Total del pedido</p><p class="text-end mb-0">' . ($totalPedido + 5) . '€</p>
                                                </div>
                                            </div>
                                            <div>
                                                <a href="ctrTienda.php" class="btn boton px-4">Volver</a>
                                                <a href="../vista/pago.php" class="btn boton2 px-4">Continuar al pago</a>
                                            </div>
                                    </section>
                                </div>               
                            </article>
